  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="w-full mt-6 flex items-center justify-center gap-2 font-black bg-brand-500 text-white py-4 rounded-2xl shadow-lg shadow-brand-500/20 hover:bg-brand-600 transition-all uppercase text-xs tracking-widest"
      >
